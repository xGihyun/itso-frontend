<script lang="ts">
	...
	import { ClosedForm, Confirmation } from '$lib/components';
						...
						<div class="text-sm lg:text-base">
							...
							<div class="p-4 space-y-4">
								<label class="flex gap-4 items-center">
									...
									<p>
										Yes, I give my consent to UMak-CCIS to gather and process my personal
										information and document for this event.
									</p>
								</label>
